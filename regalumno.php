                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="p-4">
                            ...
                            <form action="acciones/insertalumno.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user"name="grupo"
                                        placeholder="grupo">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user"name="grado"
                                        placeholder="grado">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user"name="matricula"
